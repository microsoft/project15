...
| [Developer Guide](Developer-Guide/Architecture-Overview.md) | Double click into developing on the Project 15 Open Platform. Includes deep dive into the architecture and features.                  |
...
Our [Developer's Guide](Developer-Guide/Architecture-Overview.md) is the resource to double-click into the details on the P15 Open Platform services.
